...
void explorarAmbientes(No* atual) {
    ...
    while (atual != NULL) {
        ...
        if (atual->esquerda == NULL && atual->direita == NULL) {
            printf(">>> Este ambiente nao possui mais caminhos!\n");
            break;
        }
...
int main() {
    ...
    No* quarto = criarNo("Quarto");
    No* escritorio = criarNo("Escritorio");
    No* cozinha = criarNo("Cozinha");
    ...
    salaEstar->pai = hall;
    biblioteca->pai = hall;
    quarto->pai = salaEstar;
    escritorio->pai = salaEstar;
    cozinha->pai = biblioteca;

    // Inicio da execucao
    printf("\n===============================================================\n");
    printf("                   >>> Representacao do Mapa <<<\n");
    printf("===============================================================\n");
    ...
    printf("              -------------             ----------\n");
    printf("              |           |             |        |\n");
    printf("           Quarto    Escritorio               Cozinha\n");
    printf("===============================================================\n");
